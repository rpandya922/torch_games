...
class LTA_PPO(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        super(LTA_PPO, self)._setup_model()
    ...
    def train(self) -> None:
        ...
        # freeze human prediction model params
        for (name, param) in self.policy.features_extractor.named_parameters():
            if name[:5] == "human":
    ...
    def learn(
        ...
        tb_log_name: str = "LTA_PPO",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> "LTA_PPO":

        return super(LTA_PPO, self).learn(
